...
class RecordController {
  async createRecord(req, res) {
    const {record_client, record_master, record_service, record_category, record_schedule, record_date} = req.body;
    const newRecord = await db.query(`INSERT INTO record (record_client, record_master, record_service, record_category,
      record_schedule, record_date) values ($1, $2, $3, $4, $5, $6) RETURNING *`, [record_client, record_master,
      record_service, record_category, record_schedule, record_date])
