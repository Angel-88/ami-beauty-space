...
const totalByCategoryRouter = require('./routers/total-by-category.routers');
const totalPriceByClientController = require('./routers/total-price-by-client.routers');
const clientVisitsController = require('./routers/client-visits.routers');
...
app.use('/api', totalByCategoryRouter);
app.use('/api', totalPriceByClientController);
app.use('/api', clientVisitsController);
let whitelist = ['http://localhost:4080'];
app.use(cors(
  {
